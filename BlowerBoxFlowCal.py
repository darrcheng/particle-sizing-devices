...
file = 'c:\\Users\\user\\Documents\\calrun.csv'
...
def onStart():
    ...
    def blower():
        ...
        with open(file, mode='w',newline='') as data_file:
            ...
            data_writer.writerow(['Timer','Set Voltage (V)','Measured Flow Rate (LPM)'])
            while True:
                voltage_set = 1.93
                tdac.update(voltage_set,0)
                time.sleep (30)
                while voltage_set < 2.25:
                    ...
                    data_writer.writerow([timer, voltage_set, measured])
